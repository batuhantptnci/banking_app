...
class ApiService {
  ...
  static Future<RegisterResult> register({
    ...
    if (response.statusCode == 201) {
      ...
      user['customerNumber']?.toString();

      if (customerNumber == null ||
          customerNumber.isEmpty) {
        throw Exception(
          'Müşteri numarası alınamadı.',
        );
      }
    ...
    throw Exception(
      _extractError(
        body,
        fallback:
        'Hesap oluşturulamadı (${response.statusCode})',
      ),
    );
  }
...
// ===========================================================================
  ...
  static Future<void> _saveAuthResponse(
